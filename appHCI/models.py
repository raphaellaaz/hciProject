...
class UserZT(AbstractUser):
    ...
    empresa=models.CharField(max_length=40, default='No asignado', null=False, editable=True)
...
class U_Negocios(models.Model):
    ...
    def __str__(self):
        return 'Negocios_'+str(self.departamento)
...
class Solucion(models.Model):
     ...
     def __str__(self):
        return 'Solucion_'+str(self.nombreSol)
